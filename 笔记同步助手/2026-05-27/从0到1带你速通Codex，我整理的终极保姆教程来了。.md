...
author: 数字生命卡兹克
source: 微信公众号
url: https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647682718&idx=1&sn=9e83ec07ed3e4ddf976e4d8673f80282&chksm=f1413277fe11491754ca0c6ce10ac46765d576fe7b1f75adb294876b9d6234a6f79c7ab55b99&mpshare=1&scene=1&srcid=0527c7h9uiAZ7Regz4wFJNdp&sharer_shareinfo=fdc11edcaecb8211f0f135b0e57a9183&sharer_shareinfo_first=fdc11edcaecb8211f0f135b0e57a9183#rd
saved: 2026-05-27 16:26:24
tags:
  - 笔记同步助手
id: bf790050-154a-4872-9e8a-74dfb4c0263b
---
...
发布时间：2026-05-27 09:58

最近Codex的热度，真的感觉直线飙升。

社群里一直有人问，什么时候出新的教程。

![[笔记同步助手/images/daf09fbc2ad9d9228666fbc21b78174b_MD5.png]]
...
![[笔记同步助手/images/c85ae6d128d544f1fa55a4e92919a377_MD5.jpg]]
...
![[笔记同步助手/images/d2c0e8c54c0852113a08d0e03cd29d3d_MD5.png]]

然后正常打开，进行登录。

Codex的额度是跟你的ChatGPT会员相关的，我自己一般是100美刀的会员，200刀的在Claude那边，如果你比较轻度的话，20美刀的其实也勉强能用。

![[笔记同步助手/images/1f7ec5b009f76cc399dcecdb46213bb8_MD5.jpg]]

也可以使用其他方式使用Codex，比如API key，这个就看大家自己了。

![[笔记同步助手/images/cc3e767ec1304df7fe1d8681d725b3b5_MD5.jpg]]

登录之后，这里根据你的情况随便选一个，或者跳过也行。

![[笔记同步助手/images/73500e6b004b32b2d8a8200b39fe97fb_MD5.png]]

接下来，最骚的来了，你可以从Claude Code和Cowork直接导入所有的内容。

![[笔记同步助手/images/e607458ad5437c264970ef26c74d8663_MD5.png]]
...
![[笔记同步助手/images/299666b9694db89bdf3aaadb615b706d_MD5.png]]
...
![[笔记同步助手/images/700d63d95b072b30b9d03239ee38e386_MD5.png]]

对话适合不需要绑定到特定文件夹的任务，比如做做调研、做做规划，这些零碎的小任务里。

![[笔记同步助手/images/c2fff2d77108b7cbaf5200fda70915a8_MD5.png]]
...
![[笔记同步助手/images/828ac091b7c453e655168b8e69f57e88_MD5.png]]
...
![[笔记同步助手/images/de8950f1a7d1c60eaf81aca6886fcf6b_MD5.png]]

然后，你就进入到了一个具体的项目里，也能看到对话框有变化了。

然后在对话框左下角有三档权限选择。

![[笔记同步助手/images/21d8edf2347557d169e933b0b60f0059_MD5.png]]
...
![[笔记同步助手/images/a7ddd7d9f66fe29af3a7737be2349760_MD5.png]]
...
![[笔记同步助手/images/7111c5a8c9cd2513afc9b242fb13a4cc_MD5.png]]

右下角还有一个小麦克风，就是Codex自带的语音输入，不过使用体验还是挺烂的，录完以后要等好几秒才能转写出来，不是特别推荐大家用，相比起来，你直接用豆包的语音输入法更香。

![[笔记同步助手/images/632385a8f21a24cc8280bae3b1406445_MD5.png]]

当然，用着用着，你可能会好奇自己还剩多少额度。

![[笔记同步助手/images/15ec6b48cb16d9d71268cbb85e031226_MD5.png]]

点左下角的设置，找到剩余额度，就能看到你5小时内还剩多少、这周还剩多少、啥时候刷新。

![[笔记同步助手/images/ca2c049944c78ee2be924b2378e68a6c_MD5.png]]
...
![[笔记同步助手/images/99f6d79d1684f6e8b985fb9ba7ea1b7c_MD5.png]]

常规设置设置里面的这三个，都打开。

![[笔记同步助手/images/65371cec8d57ef834bd62dc3fadd7688_MD5.png]]

往下滑，跟进行为改成引导，这样你发现中途你想修改的时候就可以直接插入，而不是必须等着那个任务做完才能进行新一轮的对话。

![[笔记同步助手/images/8c5ea10522d9a84e9ca3ce26aeaea896_MD5.png]]

如果在刚才开头那一步忘了导入Claude Code的内容，也没关系，在这里也可以补导入。

![[笔记同步助手/images/24705f416bc4b52af4c8c7131d9288b5_MD5.png]]
...
![[笔记同步助手/images/fdfe0be1c5e1c755c6e52a52f13798d7_MD5.png]]
...
![[笔记同步助手/images/b2f68e12682186b5f7aadc2d1b191ba6_MD5.png]]
...
![[笔记同步助手/images/a86ac332645006386c6d80bd98a1413c_MD5.png]]
...
![[笔记同步助手/images/6cb7871e6b9c2a9b9fa0e397e3f95bbb_MD5.png]]

然后顶部就有tab可以切换插件和技能。

![[笔记同步助手/images/2c2db3a473593b3395bf4e6659bc7b21_MD5.png]]
...
![[笔记同步助手/images/5251dd75e9ce77ee1fbd11a1f6bfd1aa_MD5.png]]

你可以直接点击右上角的管理，进入管理界面，批量管理你的插件和skills。

![[笔记同步助手/images/d0bcaaa516bd1688428214a7cf32708a_MD5.png]]

同时也自带了Skill创建器和插件创建器，你想做个啥，都可以直接右上角点创建。

![[笔记同步助手/images/fb83222f9f19b2b4f9d35b5ef1f0b7f2_MD5.png]]

然后大白话告诉他你要做什么样的技能和插件就行。

![[笔记同步助手/images/d0735ae28fc3cfbc9b0e04bd571ed115_MD5.jpg]]

如果要下载除了官方之外的skill或者插件，直接把链接甩给他就可以。

![[笔记同步助手/images/b9f254177dbe57e13d886a1cef4fbeda_MD5.png]]
...
![[笔记同步助手/images/26166ed8419f0e6b6cde82f3725f7df1_MD5.png]]

按一下左边的加号，打开计划模式的开关。

![[笔记同步助手/images/a2e1a8869c2b29447d53b1f6081722bd_MD5.png]]
...
![[笔记同步助手/images/c08b09183e1160fbfb51b41972754a24_MD5.png]]

接下来，咱们跟他说，帮我做一个Codex功能介绍的网页，要好看，要有设计感，把所有功能按层级分类展示出来。

![[笔记同步助手/images/fd64a872e3c07bbf8d1e43fa39827d91_MD5.png]]

它会先问你几个问题。

![[笔记同步助手/images/aa93aa50381b5222014d16456a630286_MD5.jpg]]

你直接点选回答就行，回答完以后，它会给你一份比较完整的方案计划。

![[笔记同步助手/images/dbaeafdb0b7d122c46e726e997ebc931_MD5.png]]
...
![[笔记同步助手/images/2d0d070eb357a50acfe36c0a473b45c6_MD5.png]]

打开之后会看到一个预览页面，中间有一条线可以左右拖动来对比。

![[笔记同步助手/images/94c39308fbdc5a7bb568e06a5abfcb3f_MD5.png]]

右上角有几个按钮。

![[笔记同步助手/images/a23c2b4da68f0323b79b61f5d9ff5093_MD5.png]]

第一个是截图，点一下就能截取当前页面，效果就像下面这样。

![[笔记同步助手/images/cd9203756bd364005f9e960993d32561_MD5.png]]
...
![[笔记同步助手/images/12bf31f27762b22d005bf7d12e530b58_MD5.png]]

而且最近刚上的一个新功能是，像字体、字号、颜色这些参数，选中之后可以直接调，改完实时就能看到效果。

![[笔记同步助手/images/b60e6479d2401ead5893c290be480cce_MD5.jpg]]

注释完，点右上角发送。

![[笔记同步助手/images/b81dc133240d1acb879f65076e7e8c7a_MD5.png]]

修改后的效果就是这样的。

![[笔记同步助手/images/57893c7baf0123e0962c42c6ce9bfb33_MD5.png]]
...
![[笔记同步助手/images/9d989167b4304250140b684dd3922ec2_MD5.png]]

输入/，就可以调用skill。

![[笔记同步助手/images/c69e27a5b84d598c8604642001460d5b_MD5.png]]
...
![[笔记同步助手/images/6ddf15ae7ddebc4cada66a0adff991c1_MD5.png]]

最后，给一份方案，确认实施计划。

![[笔记同步助手/images/849b297a9c46b3932f79e880fc45ebe8_MD5.png]]

过程同样不截图了，反正我干别的事情没管了，全是自动跑，大概二十分钟后做出来了。

![[笔记同步助手/images/54aaeec9c6815aff2a534f9bfd989ede_MD5.png]]

它给了一堆乱七八糟的文件，看不懂没关系，不知道怎么安装到手机上也没关系。

你就直接说，我现在想传到我的手机上。

![[笔记同步助手/images/0b05e63e5e4ee15831f4b844b36de2bf_MD5.png]]
...
![[笔记同步助手/images/8fca860592a83c5110a6dc5e541214a2_MD5.png]]

你其实也不用管什么事Xcode，我觉得绝大多数人电脑上大概率也没有提前安装Xcode，所以呢，你就可以用一个Codex的很屌的邪修方法，直接@Computer Use，让他来帮我搜索、下载和安装。

这里的@，是用来点名插件的。

![[笔记同步助手/images/e2fab914b47f43a019497c20e842664c_MD5.png]]

Computer Use是我平时经常使用的插件之一，也是Codex上最棒的能力之一，全世界能视觉化的操控你电脑的就没几家，Codex做的非常好了。

如果要使用，需要先去设置里把Computer Use的开关打开。

![[笔记同步助手/images/848e0fee128d4a6e07f7c8a35a35e1e4_MD5.png]]

另一个常用的就是Codex for Chrome，想要使用同样需要开启开关。

这个能沿用你Chrome里已经登录的账号状态，操控浏览器。

![[笔记同步助手/images/c642d435c73f77ba8166b7c73f9325a8_MD5.png]]

并且在这个过程中，用Tab Group来隔离工作区，不会抢你的标签页，你该干嘛干嘛。

![[笔记同步助手/images/48dc324ce8eaf500324d1a39290404b5_MD5.png]]

软件下载完之后，你都不用打开Xcode，你也不用管，你可以直接让Computer Use来帮你操作后面所有的编译步骤。

![[笔记同步助手/images/d16a7b2df5a957c87cf8340bcbb69cc2_MD5.jpg]]

用的过程中，电脑上方还会显示一个操控状态的提示条。

![[笔记同步助手/images/32f322b05642f38e31b0117ab47a799f_MD5.png||67]]

不过，碰到需要输入密码或者登录账号这种涉及安全的步骤，它会停下来，让你自己来操作。

![[笔记同步助手/images/d77ef9bcd5a2e6ff90c5d4ed5326259d_MD5.png]]

剩下的交给他一点一点自己操作就行。

![[笔记同步助手/images/762efe9b2fc80e69f66647eb843c86e2_MD5.png]]

到手机端的步骤，就只能自己来了，比如用数据线连接两台设备，开启开发者模式，重启手机，确认信任，这些跟着Codex的指引一步一步来就行。

![[笔记同步助手/images/f9c6e394324b4b5a113ece257b54db48_MD5.png]]

不一会App就装到手机上了，虽然我忘记做AppIcon了，不过这不重要。

![[笔记同步助手/images/9521ae0c73e73fd015602ef097241ec6_MD5.png]]

里面的雏形也做好了。

![[笔记同步助手/images/c937dd1ae449c0828772c3ced98c670e_MD5.png]]
...
![[笔记同步助手/images/2147c04d6958992a1e295db6c73b2e70_MD5.png]]

最后做出来也没啥问题，非常方便。

![[笔记同步助手/images/8dc4025f49d112515aae7f34615602cf_MD5.png]]

到时间了，也会跳出弹窗来提醒我。

![[笔记同步助手/images/8774db11327f3136ca67ff350465ab10_MD5.jpg]]
...
![[笔记同步助手/images/f23d0fca3b78ab2bc48c79c86b057924_MD5.png]]
...
![[笔记同步助手/images/85768a0b0b92157369899c732014039a_MD5.jpg|cover_image]]
...
内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/92657d19_1779870382369?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzIyMzA5NjEyMA%3D%3D%26mid%3D2647682718%26idx%3D1%26sn%3D9e83ec07ed3e4ddf976e4d8673f80282%26chksm%3Df1413277fe11491754ca0c6ce10ac46765d576fe7b1f75adb294876b9d6234a6f79c7ab55b99%26mpshare%3D1%26scene%3D1%26srcid%3D0527c7h9uiAZ7Regz4wFJNdp%26sharer_shareinfo%3Dfdc11edcaecb8211f0f135b0e57a9183%26sharer_shareinfo_first%3Dfdc11edcaecb8211f0f135b0e57a9183%23rd&s=obsidian)