---
title: Claude Opus 4.8 没有炸裂，炸裂的是我们对 AI 的浮躁
date: 2026-05-29
source: [[笔记同步助手/2026-05-29/Claude Opus 4.8并没有炸裂，炸裂的是中文AI圈的浮躁.md]]
status: draft
...
- Anthropic 官方于 2026-05-28 发布 Claude Opus 4.8，并称其是对 Opus 4.7 的“modest but tangible improvement”。
- 官方提到的主要更新包括：Effort control、Claude Code dynamic workflows、fast mode 速度/价格变化、诚实性与自我纠错改进。
- 官方脚注中提到 Terminal-Bench 2.1 使用 Terminus-2 public harness 报告各模型分数，同时注明 GPT-5.5 使用 Codex CLI harness 的 reported score 为 83.4%。

参考来源：Anthropic 官方博客《Introducing Claude Opus 4.8》

## 备选标题

1. Claude Opus 4.8 没有炸裂，炸裂的是我们对 AI 的浮躁
2. 别再一看到新模型就喊炸裂了
3. AI 时代真正拉开差距的，不是追新模型，而是沉淀工作流
4. Opus 4.8 发布后，我更确定普通人最该补的是判断力
5. 新模型不会让你自动变强，工作流才会

## 配图建议

- 封面图：一个人站在信息洪流和 AI 模型跑分大屏前，旁边有一条安静的工作流路径，风格克制、冷静、科技感。
- 文中图 1：从“模型新闻”到“真实能力”的转化链路：新闻 → 测试 → 工作流 → Skill → 资产。
- 文中图 2：新模型验收清单：真实任务、时间节省、错误可见、边界可控、可沉淀。
